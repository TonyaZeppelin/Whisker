...
write.csv(birth_mean_90,"results/birth_dates_mean_90.csv",row.names=FALSE)
write.csv(birth_mean_120,"results/birth_dates_mean_120.csv",row.names=FALSE)
